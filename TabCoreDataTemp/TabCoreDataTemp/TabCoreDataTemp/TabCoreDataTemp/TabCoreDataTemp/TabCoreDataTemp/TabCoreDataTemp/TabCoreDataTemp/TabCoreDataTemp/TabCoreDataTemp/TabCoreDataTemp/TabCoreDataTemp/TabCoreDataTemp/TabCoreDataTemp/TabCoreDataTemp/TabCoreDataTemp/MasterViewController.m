...
//
    ...
    // 日付型の文字列を生成
    NSString *t1 = timeStampDisp; //[dateFormatter stringFromDate:timeStampDisp];

//　スイムデータの読み込み

//    Record *record = [self.fetchedResultsController objectAtIndexPath:indexPath];
    NSString *t2 = @"....."; //record.swimdata;

//    cell.textLabel.text = [ t1 stringByAppendingString:t2];
     cell.textLabel.text = [NSString stringWithFormat:@"%@ %@",t1,t2];

//    cell.textLabel.text = [dateFormatter stringFromDate:timeStampDisp];
...
//editting 6/9 23:19 timeStamp to xx
/*
